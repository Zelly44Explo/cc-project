...
#                           -- Your tool Has been Remake By anonymous #
#########################################
import requests
import socket
import socks
...
print ('''
  ...
  ____   ____ _______ _   _ ______ _______    _____ _____ 
 |  _ \ / __ \__   __| \ | |  ____|__   __|  / ____/ ____|
 | |_) | |  | | | |  |  \| | |__     | |    | |   | |     
 |  _ <| |  | | | |  | . ` |  __|    | |    | |   | |     
 | |_) | |__| | | |  | |\  | |____   | |    | |___| |____ 
 |____/ \____/  |_|  |_| \_|______|  |_|     \_____\_____|
...
├─────────────────────────────────────────────┤
│ Link: https://github.com/Zelly44-Explo/CC-attack │
└─────────────────────────────────────────────┘''')
